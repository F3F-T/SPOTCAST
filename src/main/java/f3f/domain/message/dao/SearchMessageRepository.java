...
public interface SearchMessageRepository {
    ...
    List<MessageDTO.MessageListResponseDto> getSendListByUserId(long sender_id);

    List<MessageDTO.MessageListResponseDto> getRecipientListByUserId(long recipient_id);
