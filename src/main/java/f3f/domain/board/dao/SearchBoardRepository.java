...
public interface SearchBoardRepository {
    Page<BoardDTO.BoardListResponse> getBoardListInfoByCategoryId(String boardType, Long categoryId, String profitStatus, Pageable pageable,String isOngoing);
    Page<BoardDTO.BoardListResponse> getBoardList(String boardType, String profitStatus, Pageable pageable, String isOngoing);
